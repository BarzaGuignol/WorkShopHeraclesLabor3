...
const bird1 = new Monster('Bird', 25, 12, './images/bird.svg');
const bird2 = new Monster('Bird', 25, 12, './images/bird.svg');
const bird3 = new Monster('Bird', 25, 12, './images/bird.svg');
...
const monsters = [
  new Monster('Bird', 25, 12, './images/bird.svg', 5, 2),
  new Monster('Bird', 25, 12, './images/bird.svg', 5, 3),
  new Monster('Bird', 25, 12, './images/bird.svg', 5, 4),
  ];

const hero = new Hero('👨 Heracles', 20, 6, './images/heracles.svg', 1, 1);

const arena = new Arena(monsters, hero);
